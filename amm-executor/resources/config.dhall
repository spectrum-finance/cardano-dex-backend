...
{ 
  ...
  {- 
    ...
    Contains path for encrypted container with private key, generated by tool from
    README.md and passphrase. Generally this wallet used only for collaterals and
    rewards
  -}
  secrets =
